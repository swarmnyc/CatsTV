...
public class TVPartyCat : NSObject {

    //// Drawing Methods

    public dynamic class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 80, height: 101), resizing: ResizingBehavior = .aspectFit, number: CGFloat = 7) {
